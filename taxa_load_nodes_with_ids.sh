...
if [ "$#" -ne 11 ]; then
  echo "load_nodes.sh taxa.txt resource_id node_id_col scientific_name_col rank_col generated_auto_id_col parent_id_col has_header page_id_col is_accepted_col accepted_parent_col" >&2
  exit 1
fi
